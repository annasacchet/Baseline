"""
Inference tests sul run 15q (pilot).

Gemello di scripts/300q/inference_tests.py: stessa pipeline statistica, ma
puntata ai file del pilot 15q (15 qid, 5 per hop). Per la potenza statistica
ridotta vedi results/15q/stats/README.md.

Output: results/15q/stats/inference/*.csv + inference_summary.{csv,md}.
...
RESULTS_DIR = ROOT / "results" / "15q"
OUT_DIR = RESULTS_DIR / "stats" / "inference"
DIAG_DIR = RESULTS_DIR / "stats" / "diagnostics"

FILES = {
    "f1": RESULTS_DIR / "rewriting_chains_15q_answer_f1.csv",
    "ofs": RESULTS_DIR / "rewriting_chains_15q_openfactscore.csv",
    "bs": RESULTS_DIR / "rewriting_chains_15q_bertscore.csv",
}
...
def load_data() -> dict[str, pd.DataFrame]:
    ...
    keep_cols = ["qid", "group", "instruction_type", "run", "step", "n_hop"]
    ...
    return {"f1": f1, "ofs": ofs, "bs_base": bs_base, "bs_cons": bs_cons}
