"""
BLEURT evaluation for the NewsQA rewriting chains.
...
Uso:
  ...
  python3 scripts/newsqa/bleurt_eval_newsqa.py --f1-csv results/newsqa/rewriting_chains_newsqa_100q_answer_f1_span.csv
  python3 scripts/newsqa/bleurt_eval_newsqa.py --smoke-test
"""
...
DEFAULT_CHAINS_CSV = RESULTS_DIR / "rewriting_chains_newsqa_100q.csv"
DEFAULT_F1_CSV = RESULTS_DIR / "rewriting_chains_newsqa_100q_answer_f1_span.csv"
DEFAULT_OUTPUT = RESULTS_DIR / "rewriting_chains_newsqa_100q_bleurt.csv"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="BLEURT evaluation on NewsQA rewriting chains.")
    ...
    print("=" * 70)
    print(f"BLEURT eval (NewsQA) — checkpoint={args.checkpoint}, batch={args.batch_size}")
    ...
    # Resume support: skip already-computed rows
