...
DEFAULT_OUTPUT_CSV = REPO_ROOT / "results" / "qwen30b" / "musique" / "self_refine_chains_musique.csv"
DEFAULT_BASELINE_CSV = REPO_ROOT / "results" / "qwen30b" / "musique" / "rewriting_chains_musique.csv"
