...
DEFAULT_OUTPUT_CSV = REPO_ROOT / "results" / "qwen30b" / "fictionalqa" / "self_refine_chains_fictionalqa.csv"
DEFAULT_BASELINE_CSV = REPO_ROOT / "results" / "qwen30b" / "fictionalqa" / "rewriting_chains_fictionalqa.csv"
