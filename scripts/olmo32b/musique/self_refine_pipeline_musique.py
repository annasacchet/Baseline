...
DEFAULT_OUTPUT_CSV = REPO_ROOT / "results" / "olmo32b" / "musique" / "self_refine_chains_musique.csv"
DEFAULT_BASELINE_CSV = REPO_ROOT / "results" / "olmo32b" / "musique" / "rewriting_chains_musique.csv"
