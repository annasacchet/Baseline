"""Answer F1 on FictionalQA chains — QA model = OLMo-3.1-32B via vLLM.
...
DEFAULT_CHAINS_CSV = REPO_ROOT / "results" / "gptoss120b" / "fictionalqa" / "rewriting_chains_fictionalqa.csv"
...
def main():
    ap = argparse.ArgumentParser(description="Answer F1 on FictionalQA chains, OLMo-3.1-32B QA via vLLM.")
