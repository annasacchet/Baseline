...
DEFAULT_OUTPUT_CSV = REPO_ROOT / "results" / "gptoss120b" / "fictionalqa" / "self_refine_chains_fictionalqa.csv"
DEFAULT_BASELINE_CSV = REPO_ROOT / "results" / "gptoss120b" / "fictionalqa" / "rewriting_chains_fictionalqa.csv"
