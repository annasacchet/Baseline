...
DEFAULT_OUTPUT_CSV = REPO_ROOT / "results" / "gptoss120b" / "newsqa" / "self_refine_chains_newsqa.csv"
DEFAULT_BASELINE_CSV = REPO_ROOT / "results" / "gptoss120b" / "newsqa" / "rewriting_chains_newsqa.csv"
