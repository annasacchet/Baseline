#!/bin/bash
# Launch FictionalQA rewriting pipeline smoke test on Homer (2× RTX A6000 48GB each)
# Run this via: ssh sacchet@homer.dimi.uniud.it 'bash ~/Baseline/scripts/fictionalqa/launch_homer.sh'
...
echo "=== FictionalQA Pipeline Smoke Test on Homer ==="
echo "HF_HOME: $HF_HOME"
echo ""

# Smoke test: 1 fiction, all instructions, bf16 (no quantization)
